                ...
                document.onkeydown = function(e) {
                    ...
                    if (e.ctrlKey && e.keyCode == 13) {
                        ...
                        if (authors.length == 1) {
                            ...
                            window.$('body').append('<div id="dialog" title="В статье найдена ошибка"><form><table><tr><td>Кому: </td><td><input style="width:300px;" id="habracorrector_recipient" name="recipient" value="' + author_name + '"/></td></tr><tr><td>Тема сообщения:</td><td><input style="width:300px;" id="habracorrector_title" name="theme" value="Ошибка в статье ' + window.history.current + '"/></td></tr><tr><td>Текст сообщения:</td><td> <textarea id="habracorrector_text" cols="40" rows="7" name="text">Здравствуйте, ' + author_name + '. В вашей статье: ' + window.history.current + ' допущена ошибка в этих строках:\n' + window.getSelection().toString() + '\nЯ предлагаю такой правильный вариант:</textarea></td></tr></table></form></div>');
                            ...
                            window.$('#dialog').dialog({
                                ...
                                buttons: {
                                    "Отправить": function() {
                                        ...
                                        data) {
                                            window.$.jGrowl('Сообщение об ошибке отправлено', {});
